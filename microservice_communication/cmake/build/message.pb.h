...
PROTOBUF_ALWAYS_INLINE void HelloRequest::set_request(Arg_&& arg, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.request_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:helloworld.HelloRequest.request)
}
inline ::std::string* PROTOBUF_NONNULL HelloRequest::mutable_request()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::std::string* PROTOBUF_NONNULL HelloRequest::_internal_mutable_request() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.request_.Mutable( GetArena());
}
inline ::std::string* PROTOBUF_NULLABLE HelloRequest::release_request() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline void HelloRequest::set_allocated_request(::std::string* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
...
inline const ::std::string& HelloReply::reply() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:helloworld.HelloReply.reply)
  return _internal_reply();
}
template <typename Arg_, typename... Args_>
PROTOBUF_ALWAYS_INLINE void HelloReply::set_reply(Arg_&& arg, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.reply_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:helloworld.HelloReply.reply)
}
inline ::std::string* PROTOBUF_NONNULL HelloReply::mutable_reply()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::std::string* _s = _internal_mutable_reply();
  // @@protoc_insertion_point(field_mutable:helloworld.HelloReply.reply)
  return _s;
}
...
inline ::std::string* PROTOBUF_NONNULL HelloReply::_internal_mutable_reply() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.reply_.Mutable( GetArena());
}
inline ::std::string* PROTOBUF_NULLABLE HelloReply::release_reply() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:helloworld.HelloReply.reply)
  if ((_impl_._has_bits_[0] & 0x00000001u) == 0) {
    return nullptr;
  }
  _impl_._has_bits_[0] &= ~0x00000001u;
...
inline void HelloReply::set_allocated_reply(::std::string* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
  ...
  // @@protoc_insertion_point(field_set_allocated:helloworld.HelloReply.reply)
}
